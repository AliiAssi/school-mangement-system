                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('classes.update', $class->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            class=" text-black mt-1 block w-full border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" required>
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="grade" id="grade" value="{{ old('grade', $class->grade) }}" 
                            class="text-black mt-1 block w-full border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" required>
                            @error('grade')
                                <p class="text-red-600 dark:text-red-400 text-sm">{{ $message }}</p>
                            @enderror
