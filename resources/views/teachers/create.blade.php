                                                ...
                                                <div class="space-y-4">
                                                    @foreach($subject->classes as $class)
                                                        <div class="flex items-center mb-2">
                                                            <input type="checkbox" name="subjects[{{ $subject->id }}][grades][{{ $class->id }}][selected]" id="subject_{{ $subject->id }}_class_{{ $class->id }}" value="1" {{ old('subjects.' . $subject->id . '.grades.' . $class->id . '.selected', $teacherSubjects[$subject->id]['grades'][$class->id]['selected'] ?? false) ? 'checked' : '' }} class="h-4 w-4 border-gray-300 dark:border-gray-600 rounded">
